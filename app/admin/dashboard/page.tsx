                                ...
                                >
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                                        ...
                                        <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                                            <AdminStudentAvatar cpf={item.cpf} nome={dados?.nomeAluno ?? "Sem nome"} />
                                        ...
                                        <div className="flex items-center gap-2 sm:shrink-0 border-t border-border/20 pt-2 sm:border-0 sm:pt-0">
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 sm:flex-none flex items-center justify-center gap-1.5 rounded-xl border px-3 py-2.5 text-xs font-semibold transition-all duration-200 hover:scale-105 active:scale-95 ${hasPendingReset
                                            ...
                                            <button
                                                ...
                                                className="flex-1 sm:flex-none flex items-center justify-center gap-2 rounded-xl bg-primary/10 border border-primary/20 px-4 py-2.5 text-xs font-semibold text-primary transition-all duration-200 hover:bg-primary/20 hover:border-primary/40 hover:scale-105 active:scale-95"
                                            >
